...
const Caja = () => {
  ...
  const cambiarEstadoFacturado = async (ordenId) => {
    try {
      ...
      await axios.put(API_ENDPOINTS.ORDEN_FACTURADO(ordenId));
  ...
  const fetchOrdenes = async () => {
    try {
      const response = await axios.get(API_ENDPOINTS.FACTURA);
  ...
  const crearYGuardarFactura = async (orden) => {
    try {
      ...
      const response = await axios.post(API_ENDPOINTS.FACTURA, nuevaFactura);
