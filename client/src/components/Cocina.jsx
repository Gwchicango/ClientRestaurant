...
const revistarEstado = ()=>{
  ...
  ordenesFiltradas.forEach((orden) => {
    ...
    axios.put(API_ENDPOINTS.ORDEN_ESTADO(orden.ID_OR), {
  ...
  const handleEstadoClick = async (idOrden, nuevoEstado) => {
    ...
    try {
      await axios.put(API_ENDPOINTS.ORDEN_ESTADO(idOrden), { ESTADO_OR: nuevoEstado });
